...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/paradox_bots'),
      InlineKeyboardButton('💬 Support', url='https://t.me/paradox_anime_gang')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/spy_radios')
    ]])
    if Config.START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "home":
        ...
        format_template = await paradox_bots.get_format_template(user_id)
        await query.message.edit_text(
